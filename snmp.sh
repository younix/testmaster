...
for g in $GUDES; do
	for p in $PORTS; do
		stat=$(snmp get $snmparg gude$g .iso.org.dod.internet.private.enterprises.28507.1.1.2.2.1.3.$p)
		name=$(snmp get $snmparg gude$g .iso.org.dod.internet.private.enterprises.28507.1.1.2.2.1.2.$p)
...
# gude 4
for p in $(jot 12); do
	stat=$(snmp get $snmparg gude4 1.3.6.1.4.1.28507.56.1.3.1.2.1.3.$p)
	name=$(snmp get $snmparg gude4 1.3.6.1.4.1.28507.56.1.3.1.2.1.2.$p)
